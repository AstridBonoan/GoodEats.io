import { PHONE_HREF, EMAIL_HREF } from '../data/siteData'
    ...
    <section id="events" className="scroll-mt-20 bg-warm-white py-14 md:py-20">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-chrome-light bg-cream p-6">
          ...
          <div className="rounded-2xl border border-chrome-light bg-cream p-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-charcoal-light">
              Planning something bigger? Ask about catering and large takeout orders for offices,
