...
export function IconTruck({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10m10 0h4m-4 0a2 2 0 104 0m-4 0a2 2 0 11-4 0M3 16h10M3 16l1.5-5h3M17 16V8h3l2 4v4" />
    </svg>
  )
}
...
export function QuickInfoIcon({ name, className }) {
  const Icon = ICON_MAP[name] || IconClock
