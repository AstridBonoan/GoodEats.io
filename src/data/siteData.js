...
export const IMAGES = {
  ...
  dinerInterior: IMG('diner-interior.jpg'),
  siestaEggSando: IMG('siesta-egg-sando.jpg'),
  burger: IMG('burger.jpg'),
  gourmetBurger: IMG('gourmet-burger.jpg'),
  frenchToast: IMG('french-toast.jpg'),
  chocolateFrenchToast: IMG('chocolate-french-toast.jpg'),
  cannoliPancakes: IMG('cannoli-pancakes.jpg'),
  chickenSalad: IMG('chicken-salad.jpg'),
  wings: IMG('wings.jpg'),
  macAndCheese: IMG('mac-and-cheese-plate.jpg'),
  loadedSweetPotato: IMG('loaded-sweet-potato.jpg'),
  appetizerPlatter: IMG('appetizer-platter.jpg'),
  turkeyClub: IMG('turkey-club.jpg'),
...
export const FEATURED_DISHES = [
  ...
  },
  {
    ...
    price: '$12.50',
    image: IMAGES.loadedSweetPotato,
  },
  {
  ...
  },
  {
    ...
    price: '$19.50',
    image: IMAGES.turkeyClub,
  },
  {
    id: 'cannoli-pancakes',
    title: 'Cannoli Pancakes',
    description: 'Stacked pancakes with cannoli cream, whipped cream, chocolate drizzle, and pastry chips.',
    price: 'See menu',
    image: IMAGES.cannoliPancakes,
  },
  {
    id: 'gourmet-burger',
    title: 'Gourmet Burger',
    description: 'Onion rings, avocado, roasted peppers, and arugula on a brioche bun.',
    price: 'See menu',
    image: IMAGES.gourmetBurger,
  },
]
...
export const GALLERY_IMAGES = [
  ...
  { src: IMAGES.cannoliPancakes, alt: 'Cannoli pancakes with whipped cream and chocolate' },
  { src: IMAGES.frenchToast, alt: 'French toast with strawberries, whipped cream, and syrup' },
  { src: IMAGES.chocolateFrenchToast, alt: 'Chocolate French toast with strawberries and whipped cream' },
  { src: IMAGES.turkeyClub, alt: 'Turkey club sandwich with bacon, lettuce, tomato, and fries' },
  { src: IMAGES.gourmetBurger, alt: 'Gourmet burger with onion rings, avocado, and arugula' },
  { src: IMAGES.burger, alt: 'Good Eats burger with bacon and fries' },
  { src: IMAGES.loadedSweetPotato, alt: 'Loaded baked sweet potato with black beans and sour cream' },
